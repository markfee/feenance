...
Route::group(['before' => ''], function () {
    ...
    Route::get('/account_transactions', function () {
        return View::make('account_transactions');
    });
    Route::get('/import', function () {
        return View::make('import');
    });
    Route::get('/standing_orders', function () {
        return View::make('standing_orders');
    });
    Route::get('/potential_transfers', function () {
        return View::make('potential_transfers');
    });
    Route::get('/transfers', function () {
        return View::make('transfers');
    });
    ...
    Route::group(['prefix' => 'api/v1/'], function () {
        ...
        Route::get('accounts/{id}/refresh_balance', $NAMESPACE . 'AccountsController@refreshBalance');
