<nav class="navbar navbar-inverse">
  <div class="navbar-header">
    ...
    <a class="navbar-brand" href="{{ URL::to('/') }}">                      All Transactions</a>
    <a class="navbar-brand" href="{{ URL::to('/account_transactions') }}">  Account Transactions</a>
    <a class="navbar-brand" href="{{ URL::to('/standing_orders') }}">       Standing Orders</a>
    <a class="navbar-brand" href="{{ URL::to('/transfers') }}">             Transfers</a>
